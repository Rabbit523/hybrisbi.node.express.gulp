    ...
    multiselect.directive('multiselect', ['$filter', '$document', '$log', function ($filter, $document, $log) {
        return {
            ...
            link: function ($scope, $element, $attrs, $ngModelCtrl) {
                ...
                $scope.searchFilter = '';
                if(typeof $attrs.tblFilter === 'undefined'){
                    $scope.tblFilter = false;
                }
...
angular.module("multiselect.html", []).run(["$templateCache", function ($templateCache) {
  $templateCache.put("multiselect.html",
    ...
    "    <button type=\"button\" class=\"btn dropdown-toggle\" ng-class=\"classesBtn\" ng-click=\"toggleDropdown()\" ng-style=\"{ 'color' : !tblFilter ? '#000' : ((tblFilter && selectedOptions.length>0) ? '#F0AB00' : '#FFF') }\" ng-disabled=\"disabled\" style=\"white-space: nowrap; overflow-x: hidden; text-overflow: ellipsis;\">\n" +
    "        <span ng-show=\"!tblFilter\">{{getButtonText()}}&nbsp;<span class=\"caret\"></span></span>\n" +
    "    </button>\n" +
    "    <ul class=\"dropdown-menu dropdown-menu-form\"\n" +
    "        ng-style=\"{display: open ? 'block' : 'none'}\" ng-style=\"{width: tblFilter ? '100px!important':'inherit!important'}\" style=\"overflow-x: auto\">\n" +
    "\n" +
